...
class ProcessingSettings(BaseSettings):
    ...
    tesseract_path: Path | None = Field(default=None, description="Path to Tesseract executable")
...
class LoggingSettings(BaseSettings):
    ...
    # File logging
    file: Path | None = Field(default=Path("./logs/qcm_generator.log"), description="Log file path")
